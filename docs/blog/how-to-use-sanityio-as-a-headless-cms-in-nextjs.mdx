...
```
const query = encodeURIComponent(&#x60;*[ _type == &quot;book&quot; ]&#x60;)```<a href="https://user-24360516-d5f9-4a9d-9df1-4f3938c9563c-fhcmbheklq-uc.a.run.app/?p=22ed4b9dbc">Save this snippet</a>
...
```
const query = encodeURIComponent(&#x60;*[ slug.current == &quot;${pageSlug}&quot; &amp;&amp; _type == &quot;book&quot; ]&#x60;)```<a href="https://user-24360516-d5f9-4a9d-9df1-4f3938c9563c-fhcmbheklq-uc.a.run.app/?p=cfa7418d76">Save this snippet</a>

Now, we’ll create a URL like we did before and fetch a response.
```
const response = await fetch(url).then(res =&gt; res.json())```<a href="https://user-24360516-d5f9-4a9d-9df1-4f3938c9563c-fhcmbheklq-uc.a.run.app/?p=43c648ab06">Save this snippet</a>
...
```
const bookImage = builder.image(response.result[0].image).url()```<a href="https://user-24360516-d5f9-4a9d-9df1-4f3938c9563c-fhcmbheklq-uc.a.run.app/?p=e0464c9f8f">Save this snippet</a>
...
```
const author = await getAuthor(response.result[0].author._ref)```<a href="https://user-24360516-d5f9-4a9d-9df1-4f3938c9563c-fhcmbheklq-uc.a.run.app/?p=dd994a8aed">Save this snippet</a>
...
```
const router = useRouter()```<a href="https://user-24360516-d5f9-4a9d-9df1-4f3938c9563c-fhcmbheklq-uc.a.run.app/?p=4ce740bfc2">Save this snippet</a>
