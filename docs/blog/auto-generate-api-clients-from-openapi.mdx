...
e>```npx @nestjs/cli new open-api-nestjs-server```</pre><p>Once the project is initialized, we will add some APIs for user management. NestJS works on an <a href="https://en.wikipedia.org/wiki/Model%E2%80%93view%E2%80%93controller" target="_blank" rel="noopener noreferrer">MVC</a> pattern. We are adding a controller to host the APIs, a service to do the heavy lifting and <a href="https://en.wikipedia.org/wiki/Data_transfer_object" target="_blank" rel="noopener noreferrer">DTOs</a> for our models. This is how the user module would look:

![](flow.com/6143afec68f555387049efb3/630f8ce2c64700f586af9778_StubbeduserAPI_cfc9a855c2753297c640748d8d0af1ce_800.p)
...
![](with Swagger." src="https://uploads-ssl.webflow.com/6143afec68f555387049efb3/630f8ce2c647005421af977c_AddSwagger_2b565695eab930eeb31c99af2dbeefaf_800.p)
Now the fun starts.
...
![](w.com/6143afec68f555387049efb3/630f8ce2c647006693af977a_SwaggerJSONgenerator_b4e996db762702ce1e22f7fbfe9a987b_800.p)

<em>Note: Swagger has plugins/libraries for almost every server side programming language. There is always a way to generate ```swagger.json```.</em>
...
![](uploads-ssl.webflow.com/6143afec68f555387049efb3/630f8ce2c647009bd8af9774_Swaggergeneratorscript_8c4e760b80d531c2f2053ae3c741de1c_800.p)
...
![](/uploads-ssl.webflow.com/6143afec68f555387049efb3/630f8ce2c64700a215af9775_APIClientGeneratorScript_8265124f402cb9ad06f333890a7d430e_800.p)

## Consume the API client in the frontend application using the published npm package
This client can now be consumed:
![](ttps://uploads-ssl.webflow.com/6143afec68f555387049efb3/630f8ce2c64700b971af9773_ConsumingtheAPIClient_9784dcc3d2bc4a18930ab3c5935d559a_800.p)
...
![](flow.com/6143afec68f555387049efb3/630f8ce2c647004fd9af9772_APIclientconfig_e1c435e37cc3a5f67613de7d86f55705_800.p)

For instance, an auth token can be injected for all the requests like this:

![](s://uploads-ssl.webflow.com/6143afec68f555387049efb3/630f8ce2c647000190af9776_Injectinganauthtoken_448ce6897ac06459fe646e5d32ae55d0_800.p)
...
<em>Remember that we already have all the scripts ready in our ```package.json```. So, if you plan to automate this with any other CI, that should be straightforward.</em>
To begin, we’ll have to configure an npm to point to the GitHub npm repository. That can be done by adding a ```.npmrc``` file.
![](low.com/6143afec68f555387049efb3/630f8ce2c647006d0baf9779_image_61d77e179d75a0ffb2d61f30ed3b2e07_800.p)
...
![](s://uploads-ssl.webflow.com/6143afec68f555387049efb3/630f8ce2c647009fd1af9777_Personalaccesstoken_597b0ed6c4f547255563561c07710322_800.p)
...
![](sl.webflow.com/6143afec68f555387049efb3/630f8ce2c64700360caf977b_CIflow_88f99041f092dcc7ae0784d44c9ce9a1_800.p)
...
## The workflow
![](ads-ssl.webflow.com/6143afec68f555387049efb3/630f8ce2c64700e025af9782_GitHubAction_cf8d6dfec093f381393611491b6efab2_800.p)
<em>Note: Since we do not have integration tests or an actual deployment, they are commented in the above snippet.</em>
